...
Definition op_prod_s(a b: PauliBase): Scalar :=
  match a, b with
  | I, p => One
  | p, I => One
...
Definition op_prod(a b: PauliBase): (Scalar * PauliBase) :=
  match a, b with  
  | I, p => (One, p)
  | p, I => (One, p)  
...
Definition op_prod_alt(a b: PauliBase): (Scalar * PauliBase) := 
